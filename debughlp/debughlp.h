...
*/
	...
	#define ASSERT_VALID_HWND( hwnd )						_ASSERT( ::IsWindow( hwnd ) )
	#define ASSERT_VALID_STR_LEN( str, n )			_ASSERT( !::IsBadStringPtr( str, n ) )
	#define ASSERT_VALID_STR( str )							ASSERT_VALID_STR_LEN( str, 0xfffff )
	#define ASSERT_VALID_WRITEPTR( obj, n )			_ASSERT( !::IsBadWritePtr( obj, n ) )
	#define ASSERT_VALID_READPTR( obj, n )			_ASSERT( !::IsBadReadPtr( obj, n ) )
