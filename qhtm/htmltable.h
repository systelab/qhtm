...
{
public:
	CHTMLTable(	int nWidth, int nBorder, CStyle::Align alg, CStyle::Align valg, int nCellSpacing, int nCellPadding, CBackground &background, COLORREF crDark, COLORREF crLight);
