...
public:
	...
	bool SubmitForm( LPCTSTR pcszFormName );
	...
	//	Pagination Methods
	int Paginate(const WinHelper::CRect& rcPage, int *pIntArray = 0);	// Returns number of pages
	...
	void AddBreakSection( int i, int row = -1);
	...
	//
	//	Submit a form!
	void SubmitForm( CHTMLForm *pForm );
