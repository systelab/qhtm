...
LRESULT CALLBACK CQHTMControlSection::WndProc( HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam )
{
	...
	{
		//	Should never happen. It implies a message has been sent *after* we have been destroyed.
		_ASSERT( FALSE );
...
//			}
	...
	case WM_MOUSEACTIVATE:
		//
		//	don't activate if there are zero links on the page
//		if( pWnd->HasControls() )
		{
			WinHelper::CPoint pt;
			GetCursorPos( pt );
...
//		return MA_NOACTIVATE;
	...
	case QHTM_SUBMIT_FORM:
		return pWnd->SubmitForm( (LPCTSTR)lParam );
