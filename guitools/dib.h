...
namespace GS
{
	...
	public:
		...
		void AddImage( UINT nLeft, UINT nTop, CDIB *pDib );
		...
		void PutPixelBlend( UINT x, UINT y, BYTE r, BYTE g, BYTE b, BYTE a );
		void PutPixel( UINT x, UINT y, BYTE r, BYTE g, BYTE b, BYTE a );
		bool GetPixel( UINT x, UINT y, BYTE &r, BYTE &g, BYTE &b, BYTE &a );
