...
namespace Container
{
	...
	class CMap
	{
		...
		struct BucketEntry
		{
			...
			const BucketEntry &operator = ( const BucketEntry &rhs ){ m_Value = rhs.m_Value; m_Key = rhs.m_Key; m_pNext = rhs.m_pNext; return this; }
		...
		BucketEntry *Find( PI_uint32 uHash, const Key &key ) const;
